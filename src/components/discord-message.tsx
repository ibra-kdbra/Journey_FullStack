        ...
        <div className="w-full flex items-start justify-start">
            ...
            <div className="w-full max-w-xl">
                <div className="flex items-center">
                    ...
                    <span className="text-gray-400 ml-1.5 font-normal text-xs">
                        {timestamp}
                    </span>
                </div>
                <div className="text-sm bg-[#2f3136] w-full rounded p-3 md-4 mt-1.5">
                    <div className="flex flex-row items-center justify-between mb-2">
                        {badgeText ? <span className={cn(
                    ...
                    <p className="text-[#72767d] text-sm mt-2 flex items-center">
