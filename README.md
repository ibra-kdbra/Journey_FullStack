...
| [`vue3-clean-architecture`](vue3-clean-architecture/) | Vue 3, Vite, Pinia | Currently the `create-vue` scaffold; the layering the name promises is not built yet | in progress |
...
- [.claude/agents/](.claude/agents/) — repository-scoped subagents, modelled on [agency-agents](https://github.com/msitarzewski/agency-agents)
