      ...
      <div className="section-wrapper" ref={wrapperRef}>
        <div className="headline" ref={headlineRef}>
          ...
          <div className="headline-wrapper">
            ...
            <div className="title">
              Autonomous Network Optimization Smooth Communication
            </div>
          </div>
        </div>
        <div className="section-content">
          ...
          <div className="improved">
            <p className="subtitle">Cellular Network Data Stagnation Rate</p>
            <div className="ratio">
              <img
                src={getImageUrl(
                  '/src/assets/section-turbo-link/arrow-down.svg'
                )}
                alt=""
              />
              <p>83%</p>
