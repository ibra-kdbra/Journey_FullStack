...
```mermaid
graph LR
    A[Xem quảng cáo<br/>tuyển dụng] --> B[Chuẩn bị<br/>hồ sơ]
    B --> C[Nộp đơn<br/>ứng tuyển]
    C --> D[Phỏng vấn]
...
```mermaid
graph TD
    A[한국에서 어떤 일을 하고 싶어요?] --> B[1. 학원 강사/<br/>다문화 언어 강사]
    A --> C[2. 편의점 아르바이트/<br/>시간제 할 수 있는 일]
    A --> D[3. 사업하다/<br/>가게를 차리다]
    A --> E[4. 통역이나 번역 일을 하다/<br/>전문성 있는 일을 하다]
...
```mermaid
graph LR
    A[Mục đích<br/>취업하기 위해서] --> B[Hành động<br/>한국어를 공부해요]
...
```mermaid
graph TD
    A[Động từ gốc: 쓰다] --> B[-어 놓다]
    A --> C[-고 있다]
    A --> D[-었어요]

    B --> E[써 놓다<br/>Viết sẵn]
    C --> F[쓰고 있다<br/>Đang viết]
    D --> G[썼어요<br/>Đã viết]
...
```mermaid
flowchart LR
    A[1. Xem quảng cáo<br/>구인 광고를 보다] --> B[2. Viết hồ sơ/sơ yếu lý lịch<br/>이력서·지원서를 쓰다/작성하다]
    B --> C[3. Nộp hồ sơ<br/>서류를 제출하다]
    C --> D[4. Thi viết<br/>필기시험을 보다]
    D --> E[5. Phỏng vấn<br/>면접을 보다]
    E --> F[6. Nhận thông báo đậu<br/>합격 통보 문자를 받다]
...
```mermaid
mindmap
  root((Hồ sơ xin việc<br/>취업 서류))
    서류
      지원서<br/>Đơn xin việc
      이력서<br/>Sơ yếu lý lịch
      자기소개서<br/>Thư tự giới thiệu
    각종 증명서
      성적 증명서<br/>Bảng điểm
      졸업 증명서<br/>Chứng chỉ tốt nghiệp
      경력 증명서<br/>Chứng nhận kinh nghiệm
      자격증 관계 증명서<br/>Chứng chỉ chuyên môn
    신분증 사본
      여권 사본<br/>Bản sao hộ chiếu
      외국인 등록증 사본<br/>Bản sao đăng ký người nước ngoài
      운전면허증 사본<br/>Bản sao bằng lái xe
    자격증
      컴퓨터 자격증<br/>Chứng chỉ tin học
      운전면허증<br/>Bằng lái xe
```
