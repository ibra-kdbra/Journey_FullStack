  ...
  return (
    <section className="section-magic-ring">
      <div className="section-wrapper">
        ...
        <h2 className="title">MagicRing Trust Circle</h2>
        <p className="subtitle">Intelligent Interconnection No Boundaries</p>
        <a className="intro" href="/">
          View the list of products compatible with Intelligent Interconnection
        </a>
      </div>
    </section>
  );
