...
Three checklists, depending on what the change touches:

- [`ARCHITECTURE.md`](ARCHITECTURE.md#reviewing-a-change) — code crossing a layer boundary
- [`DESIGN.md`](DESIGN.md#9-review-checklist) — any component, page or stylesheet
- [`docs/DEPENDENCIES.md`](docs/DEPENDENCIES.md) — any dependency change

`docs/DEPENDENCIES.md` carries a table of every breakage this repository has hit.
Read it before diagnosing a dependency failure; the answer is usually already there.
