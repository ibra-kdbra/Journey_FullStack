...
const Page = () => {
    ...
    return(
        <div className="flex flex-1 w-full items-center justify-center px-4">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 text-center -translate-y-1/2">
                <LoadingSpinner size="md" />
                <Heading>Creating your account...</Heading>
                <p className="text-base/7 text-gray-600 max-w-prose">Just a moment while we set things for you.</p>
            </div>
        </div>
    )
}
