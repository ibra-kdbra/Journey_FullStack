...
```mermaid
graph LR
    A[Số lượng/Thời gian] --> B{So với mong đợi}
    B -->|Nhiều hơn| C[이나<br/>nhấn mạnh nhiều]
    B -->|Ít hơn| D[밖에 + phủ định<br/>nhấn mạnh ít]

    C --> E["예: 10만 원이나<br/>(đến 100,000 won!)"]
    D --> F["예: 10만 원밖에 안 돼요<br/>(chỉ 100,000 won thôi)"]
  ...
  root((Bài 5<br/>소비와 절약))
    ...
    Ngữ pháp
      이나/밖에
        ...
        밖에::Ít hơn mong đợi
      -ㄴ다고 하다
        Truyền đạt gián tiếp
        Câu tường thuật
    Kỹ năng
      Nói::Thảo luận chi tiêu
      Nghe::Phương pháp tiết kiệm
      Đọc::Bài báo về tiêu dùng
      Viết::Lập kế hoạch tiết kiệm
```
