        ...
        <div className="text-center sm:text-left">
          <aside className="flex items-center justify-center sm:justify-start">
            <Image
              ...
              alt="logo"
            />
            <h2 className="text-xl font-bold">Do<span className='text-blue-500'>mini</span>um</h2>
          </aside>
          <p>Contact us: info@dominium.com</p>
        </div>
        <div>
          <div className="flex justify-center sm:justify-start space-x-6 py-2">
            ...
            <Link href="https://www.linkedin.com/in/ibra-kdbra"
              className="hover:text-blue-500">
              <FaLinkedinIn size={22}/>
            </Link>
            <Link href="https://github.com/ibra-kdbra"
              className="hover:text-gray-500">
              <FaGithub size={22}/>
            </Link>
          </div>
          <p className="text-center sm:text-left">&copy; {new Date().getFullYear()} Dominium. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
