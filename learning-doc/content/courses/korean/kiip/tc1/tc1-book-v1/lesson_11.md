...
```mermaid
graph TD
    A[Tìm nhà<br/>집 구하기] --> B[Qua ứng dụng<br/>앱으로]
    A --> C[Qua môi giới<br/>부동산 중개소]
    A --> D[Qua bạn bè<br/>친구를 통해]
...
```mermaid
graph TD
    A[집 구하기<br/>Tìm nhà] --> B[매매<br/>Mua bán]
    A --> C[임대<br/>Cho thuê]

    C --> D[전세<br/>Thuê trả trước]
    C --> E[월세<br/>Thuê hàng tháng]
...
```mermaid
graph LR
    A[Đặc điểm 1<br/>교통이 편리하다] --> B[-는/-ㄴ 데다가]
    B --> C[Đặc điểm 2<br/>편의 시설이 많아요]
...
```mermaid
graph TD
    A[Dạng kết thúc câu] --> B[Hội thoại]
    A --> C[Văn viết]

    B --> D[-어요<br/>Thân mật]
    B --> E[-습니다<br/>Trang trọng]

    C --> F[-는다/-ㄴ다/-다<br/>Trang trọng]
...
graph TD
    ...
    A --> G[아파트<br/>Chung cư]
    A --> H[빌라<br/>Villa]
    A --> I[기숙사<br/>Ký túc xá]
    A --> J[원룸<br/>Phòng trọ]
    A --> K[오피스텔<br/>Officetel]
