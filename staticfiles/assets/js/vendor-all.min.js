!(function (e, t) {
    ...
    for (var n, r, o = [], i = 0, a = e.length; i < a; i++)
      (r = e[i]).style &&
        ...
        t
          ...
          : "none" !== n && ((o[i] = "none"), Ie.set(r, "display", n)));
  ...
  function H(e, t, r, o) {
    ...
    if (
      ...
      for (u = (s = xe.map(x(i, "script"), A)).length; f < p; f++)
        (l = i),
          f !== d &&
            ((l = xe.clone(l, !0, !0)), u && xe.merge(s, x(l, "script"))),
          r.call(e[f], l, f);
      if (u)
  ...
  function W(e, t, n, r, o, i) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += xe.css(e, n + Ye[a], !0, o)),
        r
          ? ("content" === n && (u -= xe.css(e, "padding" + Ye[a], !0, o)),
            "margin" !== n &&
              (u -= xe.css(e, "border" + Ye[a] + "Width", !0, o)))
          : ((u += xe.css(e, "padding" + Ye[a], !0, o)),
            "padding" !== n
              ? (u += xe.css(e, "border" + Ye[a] + "Width", !0, o))
              : (s += xe.css(e, "border" + Ye[a] + "Width", !0, o)));
    return (
      !r &&
        i >= 0 &&
        (u += Math.max(
  ...
  function K(e, t, n) {
    ...
    for (V(c, l.opts.specialEasing); i < a; i++)
      if ((r = K.prefilters[i].call(l, e, c, l.opts)))
        return (
          ye(r.stop) &&
            (xe._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
          r
        );
    return (
      xe.map(c, U, l),
      ...
      var o = n.length > 0,
        ...
        a = function (r, a, s, u, l) {
          ...
          for (
            ...
            if (i && c) {
              for (
                f = 0, a || c.ownerDocument === L || (j(c), (s = !H));
                (p = e[f++]);
      ...
      function (e, t) {
        xe.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Le[e] || xe.uniqueSort(o), je.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    xe.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = We.get(i)), 1 === i.nodeType && !Ie.get(i, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function () {
              ...
              if (r)
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ((t = Q(this)) && Ie.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      xe.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        xe.event.special[t] = {
          ...
          teardown: function () {
            ...
            o
              ? Ie.access(r, t, o)
              : (r.removeEventListener(e, n, !0), Ie.remove(r, t));
          },
        };
      });
  var Nt = e.location,
    ...
    xe.extend({
      ...
      ajax: function (t, n) {
            ...
            l
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = w.state), (p = w.data), (l = !(d = w.error))))
        ...
        (f = xe.event && h.global) &&
          ...
          h.ifModified &&
            (xe.lastModified[i] &&
              C.setRequestHeader("If-Modified-Since", xe.lastModified[i]),
  ...
  xe.ajaxSetup({
    ...
    xe.each(["top", "left"], function (e, t) {
      xe.cssHooks[t] = P(ve.pixelPosition, function (e, n) {
        if (n)
          return (n = M(e, t)), ut.test(n) ? xe(e).position()[t] + "px" : n;
      });
    }),
  ...
  (function (e, t) {
    ...
    function m(e, n) {
      ...
      return (
        (o ? n.contains(u) : n === u && "BODY" !== u.nodeName) && (m = l(m, n)),
        m
      );
    }
    function g(e) {
    ...
    function y(e, t, o, i) {
      ...
      if ("viewport" === i) a = g(u);
        ...
        "scrollParent" === i
          ? ((l = r(n(e))),
            "BODY" === l.nodeName && (l = window.document.documentElement))
      ...
      fe = (function () {
        function t(n, r) {
          ...
          oe(this, t),
            ...
            Object.keys(se({}, t.Defaults.modifiers, i.modifiers)).forEach(
              function (e) {
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var s,
                ...
                v = j("transform");
              if (
                ((u = "bottom" == m ? -f.height + d.bottom : d.top),
      ...
      slimScroll: function (n) {
        ...
        return (
          this.each(function () {
            ...
            function i(e, t, n) {
              ...
              if (
                (t &&
                  ((o =
                    parseInt(D.css("top")) +
                    ((e * parseInt(r.wheelStep)) / 100) * D.outerHeight()),
            ...
            function a() {
              (h = Math.max(
                (w.outerHeight() / w[0].scrollHeight) * w.outerHeight(),
                y
              )),
                D.css({ height: h + "px" });
            ...
            if (w.parent().hasClass(r.wrapperClass)) {
              ...
              if (
                ...
                if ("scrollTo" in n) x = parseInt(r.scrollTo);
                  ...
                  return D.remove(), k.remove(), void w.unwrap();
                i(x, !1, !0);
              }
              ...
              k.css(N),
                ...
                a(),
                "bottom" === r.start
                  ? (D.css({ top: w.outerHeight() - D.outerHeight() }),
                    i(0, !0))
                  : "top" !== r.start &&
                ...
                window.addEventListener
                  ? (S.addEventListener("DOMMouseScroll", o, !1),
